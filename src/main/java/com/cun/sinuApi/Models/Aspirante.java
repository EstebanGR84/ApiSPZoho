...
public class Aspirante {
    ...
    private String tip_inscripcion;
    ...
    public String getTip_inscripcion() {
        return tip_inscripcion;
    }

    public void setTip_inscripcion(String tip_inscripcion) {
        this.tip_inscripcion = tip_inscripcion;
    }
